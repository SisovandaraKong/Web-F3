            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex items-center mt-2 text-gray-600 dark:text-gray-400">
                  ...
                  <span className="text-sm">{userData.userType || "Full-time"}</span>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700">
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex items-start">
                    ...
                    <span className="text-sm">{userData.phone || "Phone not available"}</span>
                  </div>
                  <div className="flex items-start">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="text-sm">{userData.address || "Location not available"}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full md:w-2/3 space-y-8">
            ...
            <div>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white">CV</h2>
                <a href="#" className="text-blue-900 dark:text-blue-300 hover:underline text-sm font-medium">
                  Download Resume
                </a>
              </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 hover:shadow-md transition">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">University of Fine Art</p>
                  <p className="text-blue-900 dark:text-blue-300 font-medium mt-1">
                    Bachelor's degree, Graphic Design
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mt-1">2014 - 2017</p>
                </div>
              </div>
            </div>
            ...
            {/* Services */}
            <div>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">My Services</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {userData.skills && userData.skills.length > 0 ? (
                  ...
                  <>
                    {["Programming", "Graphic", "Content Creator"].map((service, index) => (
                      <div
                        key={index}
                        className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 flex flex-col items-center hover:shadow-md transition"
                      >
