...
export default function Footer() {
  return (
    <>
      <footer className="bg-white dark:bg-[#111827] mt-28 min-w-xs">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <h2 className="text-gray-700 dark:text-white mt-15">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                <h2 className="text-sm mb-4 font-semibold text-gray-900 uppercase dark:text-white">
                  Our Sponsors
                </h2>
                <ul>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a
                href="#"
                className="text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
