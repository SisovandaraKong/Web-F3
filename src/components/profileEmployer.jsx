...
function ProfileEmployer() {
  return (
    <div className="bg-white p-4 rounded shadow w-1/2">
      <div className="bg-white rounded shadow w-1/2 ml-[300px]">
        <div className="bg-[#283891] rounded-t p-6 text-white text-center">
          <div className="relative">
            {" "}
            {/* Add relative positioning here */}
            <img
              src="https://i.pinimg.com/474x/db/6b/5e/db6b5e958c96695867176777114003b4.jpg"
              alt="Profile"
              className="rounded-full w-20 h-20 mx-auto mb-4 object-cover"
            />
          </div>
          <h2 className="text-lg font-semibold">Zhao Lusi</h2>
