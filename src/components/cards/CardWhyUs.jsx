import { FaCheckCircle, FaLock, FaChartBar, FaStar, FaRocket, FaRobot } from "react-icons/fa";
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-md">
            ...
            <div className="space-y-6 pt-5 text-base leading-7 text-black-text dark:text-white-text transition-all duration-300 group-hover:text-white-text">
              <h3 className="text-xl font-semibold">{t(card.titleKey)}</h3> {/* Add translated title */}
