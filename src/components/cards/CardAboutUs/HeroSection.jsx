...
export default function HeroSection() {
  ...
  return (
    <div>
      <section
        className="relative bg-cover bg-center bg-no-repeat px-6 sm:px-12 lg:px-36 h-screen flex"
        style={{
        ...
        <div className="relative max-w-screen-xl px-4 py-16 sm:py-24 lg:py-32 text-center sm:text-left">
