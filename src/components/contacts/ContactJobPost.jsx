  ...
  return (
    <div className="contact" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          <h2 className="text-lg font-bold dark:text-black-text">Contact Us</h2>
          <p className="max-w-sm mt-4 mb-4 dark:text-description">
            Have something to say? We are here to help. You can call, email, or visit us at the location below.
          </p>
          <div className="flex items-center mt-8 space-x-2 text-dark-600 dark:text-black-text">
          ...
          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-black-text">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
              stroke="currentColor" aria-hidden="true" className="w-4 h-4">
              <path strokeLinecap="round" strokeLinejoin="round"
